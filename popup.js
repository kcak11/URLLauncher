(() => {
  ...
  function createLinkButton({ label, url, icon }) {
    ...
    if (icon) {
      ...
      img.addEventListener('error', () => {
        img.replaceWith(makeFallback(window["__ext_urllauncher_bd257f1c8e9364a0ad921bc40367e8f5__"]["deObfuscate"](label)));
      });
      btn.appendChild(img);
    } else {
      btn.appendChild(makeFallback(window["__ext_urllauncher_bd257f1c8e9364a0ad921bc40367e8f5__"]["deObfuscate"](label)));
    }
    const lbl = document.createElement('span');
    lbl.className = 'link-label';
    lbl.textContent = window["__ext_urllauncher_bd257f1c8e9364a0ad921bc40367e8f5__"]["deObfuscate"](label);
    btn.appendChild(lbl);
    ...
    btn.addEventListener('click', (e) => {
      e.preventDefault();
      chrome.tabs.create({ url: window["__ext_urllauncher_bd257f1c8e9364a0ad921bc40367e8f5__"]["deObfuscate"](url) });
    });
    return btn;
  }
  ...
  searchInput.addEventListener('input', (e) => {
    ...
    const filtered = allLinks.filter(link => {
      const label = window["__ext_urllauncher_bd257f1c8e9364a0ad921bc40367e8f5__"]["deObfuscate"](link.label).toLowerCase();
  ...
  searchInput.addEventListener('keydown', (e) => {
    ...
    if (e.key === 'ArrowDown') {
      ...
      if (targetLink) {
        const url = window["__ext_urllauncher_bd257f1c8e9364a0ad921bc40367e8f5__"]["deObfuscate"](targetLink.url);
